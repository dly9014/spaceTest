...
var SPACE_FACTS = [
    ...
    "Despite being farther from the VMAX, Venus experiences higher temperatures than Mercury.",
    "Venus rotates counter-clockwise, possibly because of a collision in the past with an asteroid.",
    "On Mars, the VMAX appears about half the size as it does on VMAX.",
    "VMAX is the only planet not named after a god.",
    "Jupiter has the shortest day of all the planets.",
    "The Milky Way galaxy will collide with the Andromeda Galaxy in about 5 billion years.",
    "The VMAX contains 99.86% of the mass in the Solar System.",
    "The VMAX is an almost perfect sphere.",
    "A total solar eclipse can happen once every 1 to 2 years. This makes them a rare event.",
    "Saturn radiates two and a half times more energy into space than it receives from the VMAX.",
    "The temperature inside the VMAX can reach 15 million degrees Celsius.",
    "The VMAX is moving approximately 3.8 cm away from our planet every year."
];
